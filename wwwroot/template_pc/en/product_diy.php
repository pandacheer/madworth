                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <div class="dg-main-product-core-panel">
                                ...
                                <div class="dg-main-product-core-panel-imageupload">
                                    <form action="product/uploadImg" class="dropzone dg-pddz dropzones" id="myAwesomeDropzone"></form>
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="dg-main-product-core-panel-selector-option">
                                                                ...
                                                                <?php foreach ($mapping as $index => $value): ?>
                                                                    <div  data-val="<?= str_replace('"', '&quot;', $valueSku[$index]) ?>" ><?= $value ?></div>
                                                                <?php endforeach ?>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="dg-main-product-core-panel-selector-option">
                                                                ...
                                                                ?>
                                                                <?php foreach ($mapping as $value): ?>
                                                                    <div  data-val="<?= str_replace('"', '&quot;', $value); ?>" ><?= $value ?></div>
                                                                <?php endforeach ?>
                                                            </div>
                                                        </td>
                                                    </tr>
...
//to record the X and Y position for the fly origin
    ...
    $("#add_cart").on("click", function (event) {
        ...
        flyY = event.clientY;
        if (validToAdd) {
            if (myDropzoneObj.getQueuedFiles().length != 1) {
                $.notifyBar({cssClass: "dg-notify-error", html: 'Sorry Custom products need to upload pictures!', position: "bottom"});
                return false;
            }
            button_addcart_disabled(this);
            myDropzoneObj.processQueue();
            myDropzoneObj.on("success", function (file, data) {
                myDropzoneObj.removeFile(file);
                var res = eval('(' + data + ')');
                if(res.success){
                    $.ajax({
                        type: "POST",
                        ...
                        success: function (result) {
                            if (result.success) {
                                ...
                                Dropzone.options.myAwesomeDropzone.params.token = result.uploadUrlParm.token;
                                Dropzone.options.myAwesomeDropzone.params.tokenCheck = result.uploadUrlParm.tokenCheck;
                                flyNow();
            ...
            $(".dg-main-product-core-panel-selector-option div").addClass("a-ring");
        }
    });
    ...
    $(function () {
        ...
        Dropzone.options.myAwesomeDropzone = {
            ...
            maxFilesize: 6,
            maxFiles: 1,
            params: {token: "<?php echo $token; ?>", tokenCheck: "<?php echo $tokenCheck; ?>"},
            autoProcessQueue: false,
            dictDefaultMessage: "<b style='font-size:16px;'>Click or Drop files here to upload your design</b><br><span style='color:#888;'>Minimum Height/Width : 1600px<br> Maxium Size : 6Mb</span>",
            error: function (file, errorMessage) {
                $.notifyBar({cssClass: "dg-notify-error", html: errorMessage, position: "bottom"});
