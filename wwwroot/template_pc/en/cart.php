                                            ...
                                            <td>
                                                <div class="dg-main-cart-shoppingbox-items-img">
                                                    <a href="<?= $domain ?>/collections/<?= $product['collection_url'] ?>/products/<?= $product['seo_url'] ?>">
                                                        <img alt="<?php echo htmlspecialchars_decode($product['product_title']); ?>" title="<?php echo htmlspecialchars_decode($product['product_title']); ?>" src="<?= IMAGE_DOMAIN ?><?= $product['product_image'] ?>" />
                                                    </a>
                                                    <?php if ($product['img_url']): ?>
                                                        <a href="<?= IMAGE_DOMAIN ?><?= $product['img_url'] ?>">
                                                            <img alt="<?php echo basename($product['img_url']); ?>" title="<?php echo basename($product['img_url']); ?>" src="<?= IMAGE_DOMAIN ?><?= $product['img_url'] ?>" />
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            </td>
                                            ...
                                            <td class="vertical-middle">
                                                <div class="qty_cart">
                                                    ...
                                                    <input disabled="disabled" id="qty_<?= $key ?>"
                                                           ...
                                                           data-sku="<?= htmlspecialchars($product['product_skudiy'],ENT_COMPAT); ?>" maxlength="12">
                                            ...
                                            <td class="vertical-middle">
                                                <div class="dg-main-cart-shoppingbox-items-trash">
                                                    <a href="#" id="del_<?= $key ?>" onClick="del(<?= $key ?>);
                                                            return false;" data-sku="<?= htmlspecialchars($product['product_skudiy'],ENT_COMPAT); ?>"><i class="fa fa-trash-o"></i></a>
                                                </div>
                                            </td>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-xs-5 coupon-updating">
                                    <div class="dg-main-cart-shoppingbox-coupon">
                                        ...
                                        <div class="dg-main-cart-shoppingbox-coupon-discount">
                                            <label>
                                                <table>
                                                    <tr>
                                                        <td><input type="radio"  name="ss" value="COUPON" id="couponss"></td>
                                            ...
                                            <label id="discountLabel" <?php if ($collection_offer == 0) echo 'style="display:none"' ?>>
                                                <table>
                                                    <tr>
                                                        <td><input type="radio"  name="ss" value="DISCOUNT" id="discount"></td>
                                                        <td style="padding-left: 20px">Collection Discount <?= $currency ?><span id="discountNumber"><?= $collection_offer ?></span></td>
                                                    </tr>
                                                </table>
                                            </label>
                                        </div>
