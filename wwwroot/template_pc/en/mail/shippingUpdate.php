                        ...
                        <table cellspacing="0" cellpadding="0" width="560" align="center" bgcolor="#ffffff" border="0" style="margin: 0 auto;">
                            <tr>
                                <td style="font-size: 16px;">
                                    ...
                                    <p>The following shipped items from order #9999 have been updated with new shipping information:</p>
                                    <p>1x Sledgehammer</p>
                                    <p>1x Wire Cutter</p>
                                    <p>They are being shipped via UPS with tracking number 1Z5F44813600X02768.</p>
                                    <p>You can check the status of this shipment at the following URL:</p>
                                    <p>http://wwwapps.ups.com/etracking/tracking.cgi?InquiryNumber1=1Z5F44813600X02768&TypeOfInquiryNumber=T&AcceptUPSLicenseAgreement=yes&submit=Track</p>
                                    <p>Kindly be patient as it may take some time for the status of the shipment to correctly display at the above address.</p>
