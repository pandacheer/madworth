                        ...
                        <table cellspacing="0" cellpadding="0" width="560" align="center" bgcolor="#ffffff" border="0" style="margin: 0 auto;">
                            <tr>
                                <td style="font-size: 16px;">
                                    ...
                                    <p>We would like to bring to your kind notice that the coupon issued to you will be expired on <?= date('m/d/Y H:i:s',$endDate) ?>.Kindly redeem the coupon as soon as possible to enjoy the benefit.</p>
                                    
                                    <p>To manage your coupon click here. <span style="display:inline-block; word-break:break-al"><a href="<?= $shopurl ?>/personal/coupon"><?= $shopurl ?>/personal/coupon</a></span></p>
