                        ...
                        <div class="dg-main-index-product-item">
                            <div class="dg-main-index-product-item-image" style="position: relative">
                                <div class="dg-main-index-product-item-image-shipping">
                                    <a id="productLink<?php echo $product_id ?>" href="/collections/<?= $doc['seo_url'] ?>/products/<?= $productInfo['seo_url'] ?>"><img src="<?php echo $cdn ?>image/<?php echo $freeImg;?>.png"/></a>
                                </div>
                                <a id="productLink<?php echo $product_id ?>" href="/collections/<?= $doc['seo_url'] ?>/products/<?= $productInfo['seo_url'] ?>"><img alt="<?php echo htmlspecialchars_decode($productInfo['title']) ?>" src="<?php echo $img; ?>"></a>
...
<script>
    ...
    var initPage= <?php echo $currentPage ?>;
...
<script src="<?php echo $cdn ?>js/product_list3.js"></script>
