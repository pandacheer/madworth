                        ...
                        <table cellspacing="0" cellpadding="0" width="560" align="center" bgcolor="#ffffff" border="0" style="margin: 0 auto;">
                            <tr>
                                <td style="font-size: 16px;">
                                    ...
                                    <p>As per your request DrGrab has refunded your order #<?= $refundInfo['country']?><?= $refund['order_number']?> a total of <?= $refundInfo['currency']?><?= $refund['refund_amount'] /100 ?> <?= $refundInfo['payment']?> <?php if ($refund_details[0]['refund_quantity']): ?>for:<?php endif; ?></p>
                                    
                                    <?php if ($refund_details[0]['refund_quantity']): ?>
                                        <?php foreach ($refund_details as $details): ?>
                                            <?= $details['refund_quantity']?>x <?= $details['product_name']?><br>
                                        <?php endforeach ?>
                                    <?php endif; ?>
