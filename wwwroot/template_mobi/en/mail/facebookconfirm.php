                        ...
                        <table cellspacing="0" cellpadding="0" width="560" align="center" bgcolor="#ffffff" border="0" style="margin: 0 auto;">
                            <tr>
                                <td style="font-size: 16px;">
                                    <p>Dear <?=  isset($name)&&!empty($name) ? $name : "Member"?>,</p>
                                   
                                    <p>The email ID provided by you is <?php echo $to;?></p>
                                    
                                    <p>To allow us to confirm the validity of your email address, click this verification link.</p>
                                    
                                    <p style="word-break:break-all"><a href="?php echo $confirmlink;?>" style="word-break: break-word;color: #00B6C6">?php echo $confirmlink;?></a></p>
