                        ...
                        <table cellspacing="0" cellpadding="0" width="560" align="center" bgcolor="#ffffff" border="0" style="margin: 0 auto;">
                            <tr>
                                <td style="font-size: 16px;">
                                    ...
                                    <p>We are pleased to inform you that an account has been created for you at DrGrab.</p>
                                    
                                    <p>Account: <?= $account ?> Password: <?= $password ?></p>
                                    
                                    <p>Please visit the URL below to reset your password.</p>
                                    
                                    <p style="word-break:break-all"><a href="<?= $reseturl ?>" style="word-break: break-word;"><?= $reseturl ?></a></p>
                                    
                                    <p>
                                        With this account, you will be able to:<br>
                                        1. Log in to DrGrab and save your personal info<br>
                                        2. Maintain your address book <br>
                                        3. Manage your orders<br>
                                        4. Check delivery status<br>
                                        5. Manage your active coupons<br>
                                    </p>
