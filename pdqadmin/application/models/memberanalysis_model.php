...
class MemberAnalysis_model extends CI_Model {
    ...
    function listData($country_code, $whereData, $sort = 'member_id', $order = 'desc', $offset = 0, $per_page = 10) {
        $fields = 'member_id,member_name,member_email,member_orders,last_order,order_spent';
        $this->db->select($fields);
        $this->db->from($country_code . '_member_analysis');
