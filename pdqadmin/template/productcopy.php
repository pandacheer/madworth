    ...
    <body data-color="grey" class="flat">
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <form method="post" enctype="multipart/form-data" action="/product/insert">
                    ...
                    <div id="breadcrumb">
                        ...
                        <a class="current">Add a product</a>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-lg-8">
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="producttitle" class="form-control" id="producttitle" value="<?php echo $pro['title'] ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-group" id="fileinputbox">
                                        <input name="pic[]" type="file" class="form-control" multiple="muliple" accept="image/jpeg">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input name="sold[number]" type="text" class="form-control" id="ActualSold" readonly>
                                        </div>
                                    </div>  
                                    <div class="clearfix"></div>	
                                </div>
                ...
                <div class="addvariants-hidebox-inputbox-all">
                    <div class="">
                        ...
                        <div class="clearfix"></div>
							...
							<div class="clearfix"></div>
							<div class="widget-content nopadding" >
								<input class="typeahead form-control" type="text" name="shopping_feed" value="<?php echo $pro['shopping_feed'];?>" id="erp_sku" placeholder="Google Shopping Category">
							</div>
						</div>
                        ...
                        <div class="col-xs-12 col-sm-4 col-lg-4">
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="productcontent-right-onlinestorebox pull-left">
                                        <div class="productcontent-right-onlinestorebox-left"><input name="thumb" type="file" class="form-control" accept="image/jpeg"></div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-group">
                                        <label><input name="diy" type="checkbox" class="form-control" id="dg-diy" value="1">
        ...
        function onChangeTag(){
        	...
        	var tag_array = new Array();var strs= new Array();
        ...
        function onChangeTag2(){
            ...
            var productPrice = $('#Priceinput').val()
        	for(i in r){
        		$("#addvariants-hidebox-inputbox-table tbody").append("<tr><td class=\"select\"><input type=\"checkbox\" id=\"title-checkbox\" name=\"title-checkbox\" /></td><td class=\"addvariants-inputbox\">"+escape(r[i].join('\/').toLowerCase())+"</td><td><select class=\"selectbox form-control\" id=\"status-sku-"+ escape(r[i].join('\/').toLowerCase()) +"\" name=\"details["+ i +"][status]\"><option value=\"1\">In Stock</option><option value=\"2\" >Hidden</option><option value=\"3\">Out of Stock</option></select></td><td><input type=\"text\" name=\"details["+ i +"][cost]\" id=\"cost-sku-"+escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" name=\"details["+ i +"][price]\" id=\"price-sku-"+escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" name=\"details["+ i +"][original]\" id=\"original-sku-"+ escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" name=\"details["+ i +"][bundle]\" id=\"bundle-sku-"+ escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" name=\"details["+ i +"][weight]\" id=\"weight-sku-"+escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" name=\"details["+ i +"][stock]\" id=\"stock-sku-"+ escape(r[i].join('\/').toLowerCase()) +"\"></td><td><input type=\"text\" value=\""+ SKUinput+r[i].join('\/').toLowerCase().replace(/"/g, '&quot;') +"\" name=\"details["+ i +"][sku]\"></td></tr>");
                if($("#addvariants-hidebox-inputbox-table").find("[name='details["+ i +"][price]']").val()===""){
                    $("#addvariants-hidebox-inputbox-table").find("[name='details["+ i +"][price]']").val(productPrice);
                }
            }
        ...
        $("#dg-type").typeahead({source:[<?php foreach($type as $vo){echo '"'.$vo['title'].'",';} ?>]});
        </script>
        <script>
		var $el = $('#file'),initPlugin=function(){
			$el.fileinput({
				dropZoneEnabled:true,
				uploadUrl:'/product/upPic',
