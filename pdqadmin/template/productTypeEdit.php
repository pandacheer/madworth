        ...
        <div id="wrapper">
            ...
            <div id="content">
                <form method="post" action="<?php echo site_url('category/update') ?>">
                    <input type="hidden" name='category_id' value="<?php echo $categoryInfo['_id'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="pull-right">
                                    ...
                                    <input type="submit" class="btn btn-default btn-bgcolor-blue" value="Save Product Type">
                                </div>	
                            </div>	
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-lg-12">
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" value="<?php echo $categoryInfo['title']?>" placeholder="Product Type">
                                    </div>
                                    ...
                                    <div class="dg-country-choose">
                                        <?php foreach ($language as $key => $value): ?>
                                            ...
                                            <?php foreach ($country[$key] as $country_code): ?>
                                                <input type="checkbox" name="lang-<?php echo $key ?>[]" value='<?php echo $country_code ?>' <?php if (array_key_exists($key, $country)) echo 'checked="checked"' ?> /> <img src="img/flag/<?php echo $country_code ?>.png">
                                            <?php endforeach; ?>
                                            <br /><br />
                                        <?php endforeach; ?>
                                    </div>
