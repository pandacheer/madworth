    ...
    <body data-color="grey" class="flat">
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <form method="post" enctype="multipart/form-data" action="/product/update">
                    <input type="hidden" name="_id" value="<?php echo $pro['_id'] ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-lg-6">
                                <div class="text-right">
                                    ...
                                    <a href="<?php echo site_url('comment/index') . '/' . $pro['_id'] ?>" class="btn btn-default btn-bgcolor-white" id="view-comment">Comment</a>
                                    <?php
                                    $www = $domain;
                                    ?>
                                    <?php if ($d) { ?>
                                        <a class="btn btn-default btn-bgcolor-white" href="<?= 'http://' . $www . '/collections/' . $d . '/products/' . $pro['seo_url'] ?>" target="_blank"><span class="fa fa-external-link fa-products-icon" aria-hidden="true"></span> view detail</a>
                                    <?php } else { ?>
                                        <a class="btn btn-default btn-bgcolor-white" href="<?= 'http://' . $www . '/products/' . $pro['seo_url'] ?>" target="_blank"><span class="fa fa-external-link fa-products-icon" aria-hidden="true"></span> view detail</a>
                                    <?php } ?>
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-default btn-bgcolor-white" <?php if ($last) { ?>onclick="location.href = '/product/edit/<?php echo $last; ?>'"<?php } else {
                                        echo 'disabled="disabled"';
                                    } ?>><i class="fa fa-chevron-down"></i></button>
                                        <button type="button" class="btn btn-default btn-bgcolor-white" <?php if ($next) { ?>onclick="location.href = '/product/edit/<?php echo $next; ?>'"<?php } else {
                                        echo 'disabled="disabled"';
                                    } ?>><i class="fa fa-chevron-up"></i></button>
                                    </div>
                                    <button type="button" class="btn btn-default btn-bgcolor-white" onclick="location.href = 'http://<?php echo $_SERVER['HTTP_HOST']; ?>/product/duplicatePro/<?php echo $self_id; ?>'">Duplicate</button>
                                    <button type="submit" class="btn btn-default btn-bgcolor-white">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="breadcrumb">
                        <a href="/product" title="Go to Product List" class="tip-bottom"><i class="fa fa-tags"></i> Products</a>
                        <a class="current">Edit a product</a>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-lg-8">
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                <div class="form-group">
                                    ...
                                    <input name="title" type="producttitle" class="form-control" id="producttitle" value="<?php if (strpos(htmlspecialchars_decode($pro['title']), '&amp;') !== false) {
                                        echo htmlspecialchars_decode($pro['title']);
                                    } else {
                                        echo $pro['title'];
                                    }; ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="summernote"><?php echo htmlspecialchars_decode($pro['description']) ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="specification">Specification</label>
                                    <textarea name="specification" class="summernote"><?php echo isset($pro['specification']) ? htmlspecialchars_decode($pro['specification']) : ''; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="topreview">topReview</label>
                                    <textarea name="topreview" class="summernote"><?php echo isset($pro['topreview']) ? htmlspecialchars_decode($pro['topreview']) : ''; ?></textarea>
                                </div>
                            </div>	
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                ...
                                <div id="pics" class="widget-content nopadding">
                                    <iframe src="/upimg/index/<?php echo $pro['_id'] ?>" name="ifm" style="width:100%;height:200px;border:none;"></iframe>
                                </div>
                            </div>
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left widget-box-hledit-productadd-left-Pricingbox">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="form-group col-sm-6">
                                            <label for="CostPrice">Cost Price</label>
                                            <input name="cost" type="text" class="form-control" id="CostPrice" placeholder="￥" value="<?php echo $pro['cost'] / 100 ?>" >
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="GrossMargin">Gross Margin</label>
                                            <div class="input-group nopadding">
                                                <input name="gross" type="text" class="form-control" id="GrossMargin" value="<?php echo $pro['gross'] ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="price" type="text" class="form-control" id="Priceinput" value="<?php echo $pro['price'] / 100 ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="Original">Original</label>
                                                    <input name="original" type="text" class="form-control" value="<?php echo $pro['original'] / 100 ?>" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label for="Bundle">Bundle</label>
                                                    <input name="bundle" type="text" class="form-control" value="<?php echo $pro['bundle'] / 100 ?>" />
                                                </div>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="form-group col-sm-6">
                                            <input type="checkbox" id="freebies" name="freebies"<?php echo $pro['freebies'] == 1 ? " checked" : ""; ?> /><span style="vertical-align: super;">This is a freebies product</span>
                                        </div>
                                    </div>  
                                    <div class="clearfix"></div>	
                                </div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="form-group col-sm-6">
                                            <label for="InitialSold">Initial Sold</label>
                                            <input name="sold[init]" type="text" class="form-control" id="InitialSold" value="<?php echo $pro['sold']['init'] ?>">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="ActualSold">Actual Sold</label>
                                            <input name="sold[number]" type="text" class="form-control" id="ActualSold" value="<?php echo isset($pro['sold']['number']) ? $pro['sold']['number'] : 0; ?>" readonly>
                                        </div>
                                        <div style="width:100%;">
                                            <div class="input-group">
                                                <input type="text" id="datepicker1" name="s" value="" class="form-control" placeholder="Start Time..." aria-describedby="basic-addon2">
                                                <span class="input-group-addon" id="basic-addon2">To</span>
                                                <input type="text" id="datepicker2" value="" name="e" class="form-control" placeholder="End Time..." aria-describedby="basic-addon2">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-default gosoldbydate">Go!</button>
                                                </span> 
                                            </div>
                                            <table style="width: 100%;" id="tsold">
                                                <tr><th style="width:150px;">加载中</th><th>US</th><th>GB</th><th>AU</th><th>CA</th><th>IE</th><th>NZ</th><th>SG</th></tr>
                                                <tr><td style="width:150px;">销售量</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td></tr>
                                                <tr><td style="width:150px;">销售额</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td></tr>
                                            </table>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="form-group col-sm-6">
                                            <label for="SKUinput">SKU <span class="subdued">(Stock Keeping Unit)</span></label>
                                            <input name="sku" type="text" class="form-control" id="SKUinput" value="<?php echo $pro['sku'] ?>">
                                        </div>
                                        <div class="form-group col-sm-6">
                                            <label for="Inventorypolicy">Inventory policy</label>
                                            <select name="track" class="selectbox">
                                                <option value="1"<?php echo $pro['track'] == 1 ? ' selected="selected"' : '' ?>>Don't track inventory</option>
                                                <option value="2"<?php echo $pro['track'] == 2 ? ' selected="selected"' : '' ?>>Use ERP data</option>
                                            </select>
                                        </div>
                                    </div>  
                                    <div class="clearfix"></div>	
                                ...
                                <div class="widget-content nopadding">
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <h5>
                                                <input name="weight" type="text" class="group-radius-left" value="<?php echo $pro['weight'] ?>">
                                                <select class="form-control group-radius-right">
                                ...
                                <div class="widget-title"> 
                                    <div class="col-sm-9 productadd-Variants-left">
                                        <h4>Variants</h4>
                                        <h6>Does this product come in multiple variations like size or color?</h6>
                                    </div>
                                    <div class="col-sm-3 text-right">
                                        <button type="button" class="btn btn-default btn-bgcolor-blue" id="addvariants-btn">Add variants</button>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="widget-content nopadding" id="addvariants-hidebox" >
                                    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                        <div class="addvariants-hidebox-title">
                                            <span class="col-sm-3">Option</span>
                                            <span class="col-sm-3">Values</span>
                                            <span class="col-sm-3">Option Mapping</span>
                                            <span class="col-sm-3">Values Mapping</span>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="addvariants-hidebox-inputbox-all" id="productpop">
                                            <div class="addvariants-hidebox-inputbox">
                                                <div class="col-sm-3"><input type="text" id="pdo0" name="variants[0][option]"></div>
                                                <div class="col-sm-3 option-values"><input type="text" class="tags" id="pdv0" class="tags" name="variants[0][value]"></div>
                                                <div class="col-sm-3 option-values"><input type="text" id="pdom0" name="variants[0][option_map]"></div>
                                                <div class="col-sm-3"><input type="text" class="tagst" id="pdvm0" name="variants[0][value_map]"></div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                        <div class="Addoptionbox col-sm-12">
                                            <button type="button" class="btn btn-default btn-bgcolor-white" id="Addoptionbtn">Add another option</button>
                                        </div>
                                        <div class="addvariants-hidebox-inputbox-selectvariants">
                                            <h5>Modify the variants to be created:</h5>
                                            <table class="table table-striped" id="addvariants-hidebox-inputbox-table">
                                                <thead>
                                                    <tr>
                                                        <th class="select"><input type="checkbox" id="title-checkbox" name="title-checkbox" /></th>
                                                        <th class="addvariants-inputbox">Variant</th>
                                                        <th class="addvariants-inputbox">Status</th>
                                                        <th class="addvariants-inputbox">Cost</th>
                                                        <th class="addvariants-inputbox">Price</th>
                                                        <th class="addvariants-inputbox">Original</th>
                                                        <th class="addvariants-inputbox">Bundle</th>
                                                        <th class="addvariants-inputbox">Weight</th>
                                                        <th class="addvariants-inputbox">Stock</th>
                                                        <th class="addvariants-inputbox">SKU</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                </tbody>
                            ...
                            <!--<div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                    <div class="widget-title"> 
                                        <div class="col-sm-9 productadd-Variants-left">
                                              <h4>Bulk purchase</h4>
                                              <h6>Whether to keep other properties this product bundling?</h6>
                                            </div>
                                            <div class="col-sm-3 text-right">
                                              <button type="button" class="btn btn-default btn-bgcolor-blue" id="Bundling-btn">Add Bundling</button>
                                            </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="widget-content nopadding" id="" >
                                            <div class="row">
                                                    <span class="col-sm-6">Number</span>
                <span class="col-sm-6">Price</span>
                                                    <div class="clearfix"></div>
                                            </div>
            <div class="row">
                            <?php
                            $number = '';
                            $price = '';
                            if (isset($pro['plural']) && count($pro['plural']) > 0) {
                                $i = 0;
                                foreach ($pro['plural'] as $vo) {
                                    $number[$i] = $vo['number'];
                                    $price[$i] = $vo['price'] / 100;
                                    $i++;
                                }
                            ...
                            ?>
                <div class="col-sm-6"><input type="text" class="tags" name="bnumber" value="<?php echo $number; ?>"></div>
                <div class="col-sm-6"><input type="text" class="tags" name="bprice" value="<?php if ($price) {
                                echo ($price);
                            } ?>"></div>
                <div class="clearfix"></div>
                                            </div>
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                <div class="widget-title"> 
                                    <div class="col-sm-9 productadd-Variants-left">
                                        <h4>Google Shopping Category</h4>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="widget-content nopadding" id="sku_typehead">
                                    <input class="typeahead form-control" name="shopping_feed" value="<?php echo $pro['shopping_feed']; ?>" type="text" id="erp_sku" placeholder="Google Shopping Category">
                                </div>
                            </div>
                            <!--div class="widget-box widget-box-hledit widget-box-hledit-productadd-left widget-box-hledit-productadd-left-Pricingbox">
                                    <div class="widget-title"> 
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="widget-content nopadding" id="Bundling-hidebox" >
                                        <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
                                                    <div class="addvariants-hidebox-title">
                                                            <span class="col-sm-8">Product SKU</span>
                    <span class="col-sm-4 nopadding">Price</span>
                                                            <div class="clearfix"></div>
                                                    </div>
                <div class="addvariants-hidebox-inputbox-all">
                    <div class="">
                        <div class="col-sm-8"><input type="text" class="tags" id="" class="tags" name=""></div>
                        <div class="col-sm-4">
                            <div class="input-group">
                        ...
                        <div class="clearfix"></div>
                                                    ...
                                                    <div class="addvariants-hidebox-inputbox-selectvariants">
                                                            ...
                                                            <table class="table table-striped" id="">
                                                                    <thead>
                                                                            <tr>
                                                                                    <th class="addvariants-inputbox">Bundle product SKU</th>
                                                                                    <th class="addvariants-inputbox">Price</th>
                                                                            </tr>
                                                                    </thead>
                                                                    <tbody>
                                                                            <tr>
                                                                                    <td>PRO-4301/Black,PRO-4301/Black,PRO-4301/BlackPRO-4301/Black,PRO-4301/Black</td>
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
                                ...
                                <div id="productadd-website-seo-hidebox">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input name="seo[title]" type="text" class="form-control" id="page-title-seo" placeholder="SEO page title" value="<?php echo $pro['seo']['title'] ?>" />
                                    </div>
                                    <div class="form-group col-sm-12">
                                        <label for="Metadescription">Meta description</label>
                                        <textarea name="seo[description]" class="form-control" id="page-description" rows="3"><?php echo $pro['seo']['description'] ?></textarea>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        <label for="URLandhandle">URL andhandle</label>
                                        <div class="input-group nopadding">
                                            <div class="input-group-addon">http://www.drgrab.com/</div>
                                            <input name="seo_url" type="text" class="form-control" id="page-url-seo" value="<?php echo $pro['seo_url'] ?>">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
...
<?php
if (@fopen(IMAGE_DOMAIN . '/product/' . $pro['sku'] . '/' . $pro['sku'] . '.jpg', 'r')) {
    echo '<div class="productcontent-right-onlinestorebox-left"><img src="' . IMAGE_DOMAIN . '/product/' . $pro['sku'] . '/' . $pro['sku'] . '.jpg?' . time() . '" width="368"><br><a picurl="/product/' . $pro['sku'] . '/' . $pro['sku'] . '.jpg" class="rmthumb">Remove Pic</a></div>';
} else {
    echo '<div class="productcontent-right-onlinestorebox-left"><input name="thumb" type="file" class="form-control" accept="image/jpeg"></div>';
}
?>
                                    </div>
                                </div>
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="productcontent-right-onlinestorebox-left">
                                        <select name="status" class="selectbox statusbox">
                                            <option value="1"<?php echo $pro['status'] == 1 ? ' selected="selected"' : '' ?>>In Stock</option>
                                            <option value="2"<?php echo $pro['status'] == 2 ? ' selected="selected"' : '' ?>>Hidden</option>
                                            <option value="3"<?php echo $pro['status'] == 3 ? ' selected="selected"' : '' ?>>Out of Stock</option>
                                        </select>
                                    </div> 
                                </div>
                                <div class="clearfix"></div>
                            ...
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-group">
                                        ...
                                        <input name="type" type="text" class="form-control" id="dg-type" autocomplete="off" value="<?php echo $pro['type'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Creator</label>
                                        <input name="creator" type="text" class="form-control" id="dg-creator" value="<?php echo $pro['creator'] ?>" readOnly>
                                    </div>
                                    <div class="form-group">
...
foreach ($collection as $vo) {
    if (in_array($vo['_id'], $col)) {
        echo '<option value="' . $vo['_id'] . '" selected="selected">' . $vo['title'] . '</option>';
    } else {
...
?>
                                        ...
                                        <input name="collection" type="hidden" id="hiddenselectval" value="<?php echo implode(',', $col); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Countdown</label>
                                        <select name="countdown" class="selectbox">
                                            <option value="">undefined</option>
<?php
foreach ($countdown as $vo) {
    if ($vo['id'] == $cur_countdown['_id']) {
        echo '<option value="' . $vo['id'] . '" selected="selected">' . $vo['name'] . '</option>';
    } else {
...
?>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">relativeProduct</label>
                                        <select class="js-example-basic-multiple1" multiple="multiple">
                                            <?php
                                            if (!empty($sku_list)) {
                                                foreach ($sku_list as $sku) {
                                                    if (in_array($sku, $pro['relativeproduct'])) {
                                                        echo '<option value="' . $sku . '" selected="selected">' . $sku . '</option>';
                                                    } else {
                                        ...
                                        <input name="relativeproduct" type="hidden" id="hiddenselectval1" value="<?php echo implode(',', $pro['relativeproduct']); ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tags1</label>
                                        <input name="tag[Tag1]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer" value="<?php echo $pro['tag']['Tag1'] == NULL ? '' : $pro['tag']['Tag1'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tags2</label>
                                        <input name="tag[Tag2]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer" value="<?php echo is_array($pro['tag']['Tag2']) ? implode(',', $pro['tag']['Tag2']) : ''; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Tags3</label>
                                        <input name="tag[Tag3]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer" value="<?php echo is_array($pro['tag']['Tag3']) ? implode(',', $pro['tag']['Tag3']) : ''; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Keyword</label>
                                        <textarea name="seo[keyword]" class="form-control" placeholder="HTML,CSS,XML,JavaScript"><?php echo $pro['seo']['keyword'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-group">
                                        <label><input name="diy" type="checkbox" class="form-control" id="dg-diy" value="1"<?php if (isset($pro['diy'])&&$pro['diy']== 1) echo " checked"; ?>>
                                            <span style="vertical-align: super;">Whether this product is a custom product</span></label>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
                                ...
                                <div class="widget-content nopadding">
                                    <div class="form-group">
                                        <label><input name="GF_enable" type="checkbox" class="form-control" id="dg-GF_enable" value="1"<?php if ($pro['GF_enable'] == 1) echo " checked"; ?>>
                                            <span style="vertical-align: super;">This product requires additional Google Feed info</span></label>
                                    </div>
                                    <div id="google"<?php if ($pro['GF_enable'] == 0) echo ' style="display: none"'; ?>>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Color</label>
                                            <input name="GF_color" type="text" placeholder="White,Black,Red" class="form-control tags-rightinput" id="dg-GF_color" autocomplete="off" value="<?php echo $pro['GF_color']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Size</label>
                                            <input name="GF_size" type="text" class="form-control tags-rightinput" placeholder="S,M,L,XL" id="dg-GF_size" autocomplete="off" value="<?php echo $pro['GF_size']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Gender</label>
                                            <select class="selectbox" name="GF_gender">
<?php
$gender = array('male', 'female', 'unisex');
foreach ($gender as $vo) {
    if ($vo == $pro['GF_gender']) {
        echo '<option value="' . $vo . '" selected="selected">' . $vo . '</option>';
    } else {
        echo '<option value="' . $vo . '">' . $vo . '</option>';
    }
}
?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="GF_agegroup" class="selectbox">
<?php
$agegroup = array('newborn', 'infant', 'toddler', 'kids', 'adult');
foreach ($agegroup as $vo) {
    if ($vo == $pro['GF_agegroup']) {
        echo '<option value="' . $vo . '" selected="selected">' . $vo . '</option>';
    } else {
        echo '<option value="' . $vo . '">' . $vo . '</option>';
    }
...
<?php foreach ($language as $key => $value): ?>
                                    <input type="checkbox" class="select-all" data-lang="<?php echo $key ?>"/> <span style="vertical-align: super;"><?php echo $value ?></span> <br/>
    <?php foreach ($country[$key] as $country_code): ?>
                                        <input type="checkbox" name="lang-<?php echo $key ?>[]" value='<?php echo $country_code ?>'/> 
                                        <span style="vertical-align: super;"><img src="img/flag/<?php echo $country_code ?>.png"></span>
    <?php endforeach; ?>
                                    <br /><br />
<?php endforeach; ?>
                            </div>
...
<script>
                ...
                function soldbydate(){
                    var loadlabel = $('#tsold').find('tr:eq(0)').find('th:eq(0)');
                    loadlabel.html('加载中');
                    var datepicker1 = $('#datepicker1').val(),datepicker2 = $('#datepicker2').val();
                    var proid = "<?php echo (string)$pro['_id'] ?>";
                    $.post("/product/soldbydate",{'id':proid,'s':datepicker1,'e':datepicker2},function(res){
                        loadlabel.html('');
                        var r = res.split(',');
                        $('#tsold').html(r[0]);
                        $('#datepicker1').val(r[1]);
        ...
        <script type="text/javascript">
                                        ...
                                        $('#dg-GF_enable').on('ifChecked', function (event) {
                                            $('#google').show();
                                        });
                                        $('#dg-GF_enable').on('ifUnchecked', function (event) {
                                            $('#google').hide();
                                        });
                                        // $('#view-comment').on('click',function(){
                                        // 	alert();
                                        // 	window.location.href="";
                                        // 	//$.pos("<?php echo site_url('comment/index') ?>",{txtKeyWords: "<?php echo $pro['_id'] ?>" });
                                        // 	// <form method="post" action="<?php echo site_url('comment/index') ?>" target="_blank">
                                        //  //            <input type="hidden"  name="txtKeyWords" value="<?php echo $pro['_id'] ?>">
                                        // });
                                        $('.addvariants-hidebox-inputbox-all').mouseover(function () {
                                            Sortable.create(productpop, {
                                                handle: '.addvariants-hidebox-inputbox',
                                                animation: 150,
                                                onEnd: function () {
                                        ...
                                        $(function () {
                                            ...
                                            $(".statusbox").val(<?php echo $pro['status'] ?>);
                                            $('.selectbox').select2();
                                        });

                                        //addvariants show hide
                                        $(document).ready(function () {


                                            $("#addvariants-btn").click(function () {
                                                $("#addvariants-hidebox").animate({
                                                    height: 'toggle', opacity: 'toggle'
                                                }, 300);
                                                return false;
                                            });
                                            $('.rmthumb').click(function () {
                                                var picurl = $(this).attr('picurl');
                                                var tdiv = $(this).parent('.productcontent-right-onlinestorebox-left');
                                                $.ajax({
                                                    type: 'POST',
                                                    url: "/product/removethumb",
                                                    data: {picurl: picurl},
                                                    success: function (data) {
                                                        if (data['status'] == 200) {
                                                            tdiv.html('<input name="thumb" type="file" class="form-control" accept="image/jpeg">');
                                                        }
                                                    }
                                                })
                                            });
                                        ...
                                        function onChangeTag() {
                                            $(".addvariants-hidebox-inputbox-selectvariants").show();
                                            $("#addvariants-hidebox-inputbox-table tbody").empty();
                                            var tag_array = new Array();
                                            var strs = new Array();
                                            //$("#pd0").val($('#pd0-change').val());
                                            $(".addvariants-hidebox-inputbox").each(function (i) {
                                                var gettags = $('#pdv' + i).val();
                                                strs = gettags.split(",");
                                                tag_array[i] = strs;
                                                if (productJson.variants[i] && productJson.variants[i].value === productJson.variants[i].value_map) {
                                                    $("#pdvm" + i).importTags('');
                                                    $("#pdvm" + i).importTags($("#pdv" + i).val());
                                                }


                                            })
                                            var r = combin(tag_array);
                                            var SKUinput = $("#SKUinput").val() ? $.trim($("#SKUinput").val()) + "/" : '';
                                            var productPrice = $('#Priceinput').val();
                                            for (i in r) {
                                                $("#addvariants-hidebox-inputbox-table tbody").append("<tr><td class=\"select\"><input type=\"checkbox\" id=\"title-checkbox\" name=\"title-checkbox\" /></td><td class=\"addvariants-inputbox\">" + r[i].join('\/').toLowerCase() + "</td><td><select class=\"selectbox form-control\" id=\"status-sku-" + escape(r[i].join('\/').toLowerCase()) + "\" name=\"details[" + i + "][status]\"><option value=\"1\">In Stock</option><option value=\"2\" >Hidden</option><option value=\"3\">Out of Stock</option></select></td><td><input type=\"text\" name=\"details[" + i + "][cost]\" id=\"cost-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][price]\" id=\"price-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][original]\" id=\"original-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][bundle]\" id=\"bundle-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][weight]\" id=\"weight-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][stock]\" id=\"stock-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" value=\"" + SKUinput + r[i].join('\/').toLowerCase().replace(/"/g, '&quot;') + "\" name=\"details[" + i + "][sku]\"></td></tr>");
                                                if ($("#addvariants-hidebox-inputbox-table").find("[name='details[" + i + "][price]']").val() === "") {
                                                    $("#addvariants-hidebox-inputbox-table").find("[name='details[" + i + "][price]']").val(productPrice);
                                                }
                                            }
                                            for (var k = 0; k < productJson.details.length; k++) {
                                                $("#addvariants-hidebox-inputbox-table").find("[id='price-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].price);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='cost-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].cost);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='original-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].original);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='bundle-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].bundle);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='weight-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].weight);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='stock-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].stock);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='status-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].status);
                                            }

                                        }
                                        $('#pipdate').on('click', function () {
                                            $('#addvariants-hidebox-inputbox-table tr td:nth-child(4)').find('input').val($("input[name='price']").val());
                                            $('#addvariants-hidebox-inputbox-table tr td:nth-child(5)').find('input').val($("input[name='original']").val());
                                            $('#addvariants-hidebox-inputbox-table tr td:nth-child(6)').find('input').val($("input[name='bundle']").val());
                                            return false;
                                        });
                                        function onChangeTag2() {
                                            $(".addvariants-hidebox-inputbox-selectvariants").show();
                                            $("#addvariants-hidebox-inputbox-table tbody").empty();
                                            var tag_array = new Array();
                                            var strs = new Array();
                                            ...
                                            var productPrice = $('#Priceinput').val()
                                            for (i in r) {
                                                $("#addvariants-hidebox-inputbox-table tbody").append("<tr><td class=\"select\"><input type=\"checkbox\" id=\"title-checkbox\" name=\"title-checkbox\" /></td><td class=\"addvariants-inputbox\">" + r[i].join('\/').toLowerCase() + "</td><td><select class=\"selectbox form-control\" id=\"status-sku-" + escape(r[i].join('\/').toLowerCase()) + "\" name=\"details[" + i + "][status]\"><option value=\"1\">In Stock</option><option value=\"2\" >Hidden</option><option value=\"3\">Out of Stock</option></select></td><td><input type=\"text\" name=\"details[" + i + "][cost]\" value=\"" + $("input[name='cost']").val() + "\" id=\"cost-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][price]\" value=\"" + $("input[name='price']").val() + "\" id=\"price-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][original]\" value=\"" + $("input[name='original']").val() + "\" id=\"original-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][bundle]\" value=\"" + $("input[name='bundle']").val() + "\"  id=\"bundle-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][weight]\" value=\"" + $("input[name='weight']").val() + "\" id=\"weight-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" name=\"details[" + i + "][stock]\" id=\"stock-sku-" + escape(r[i].join('\/').toLowerCase()) + "\"></td><td><input type=\"text\" value=\"" + SKUinput + r[i].join('/').replace(/"/g, '&quot;') + "\" name=\"details[" + i + "][sku]\"></td></tr>");
                                                if ($("#addvariants-hidebox-inputbox-table").find("[name='details[" + i + "][price]']").val() === "") {
                                                    $("#addvariants-hidebox-inputbox-table").find("[name='details[" + i + "][price]']").val(productPrice);
                                                }
                                            }
                                            for (var k = 0; k < productJson.details.length; k++) {
                                                $("#addvariants-hidebox-inputbox-table").find("[id='price-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val($("input[name='price'].val()"));
                                                $("#addvariants-hidebox-inputbox-table").find("[id='original-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].original);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='cost-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].cost);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='bundle-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].bundle);
                                                $("#addvariants-hidebox-inputbox-table").find("[id='weight-sku-" + productJson.details[k].option.replace(/\(/g, "\\(").replace(/\)/g, "\\)").replace(/\//g, "\\/").toLowerCase() + "']").val(productJson.details[k].weight);
                                        ...
                                        var vi = 1;
                                        function addVariant() {
                                            $(".addvariants-hidebox-inputbox-all").append("<div class=\"addvariants-hidebox-inputbox\"><div class=\"col-sm-3\"><input type=\"text\" id=\"pdo" + vi + "\" name=\"variants[" + vi + "][option]\"></div><div class=\"col-sm-3 option-values\"><input type=\"text\" class=\"tags\" id=\"pdv" + vi + "\" class=\"tags\" name=\"variants[" + vi + "][value]\"></div><div class=\"col-sm-3 option-values\"><input type=\"text\" id=\"pdom" + vi + "\" name=\"variants[" + vi + "][option_map]\"></div><div class=\"col-sm-3\"><input type=\"text\" class=\"tagst\" id=\"pdvm" + vi + "\" name=\"variants[" + vi + "][value_map]\"></div><div class=\"clearfix\"></div></div>");
                                            vi++;
                                            $('.tags').tagsInput({height: '46px', defaultText: '', width: 'auto',
                                            ...
                                            $('.tagst').tagsInput({height: '46px', defaultText: '', width: 'auto'});
                                        }
        </script>
        <script>
            var vi = 1;
            $("#Addoptionbtn").on('click', function () {
                ...
                $(".addvariants-hidebox-inputbox-all").append("<div class=\"addvariants-hidebox-inputbox\"><div class=\"col-sm-3\"><input type=\"text\" id=\"pdo0\" name=\"variants[" + vi + "][option]\"></div><div class=\"col-sm-3 option-values\"><input type=\"text\" class=\"tags\" id=\"pdv" + vi + "\" class=\"tags\" name=\"variants[" + vi + "][value]\"></div><div class=\"col-sm-3 option-values\"><input type=\"text\" id=\"pdom" + vi + "\" name=\"variants[" + vi + "][option_map]\"></div><div class=\"col-sm-3\"><input type=\"text\" class=\"tags\" id=\"pdvm" + vi + "\" name=\"variants[" + vi + "][value_map]\"></div><div class=\"clearfix\"></div></div>");
                vi++;
                $('.tags').tagsInput({height: '46px', defaultText: '', width: 'auto',
                    onAddTag: function (tag) {
                        onChangeTag2();
            ...
            $(function () {
                ...
                productJson = {
                    "_id": "<?php echo $pro['_id'] ?>",
                    "variants": [
<?php
foreach ($pro['variants'] as $vo) {
    $option_map = isset($vo['option_map']) ? addslashes($vo['option_map']) : '';
    $value_map = isset($vo['value_map']) ? addslashes($vo['value_map']) : '';
    echo '{"option":"' . addslashes($vo['option']) . '","value":"' . addslashes($vo['value']) . '","option_map":"' . $option_map . '","value_map":"' . $value_map . '"},';
}
?>
                    ],
                    "details": [
<?php
foreach ($pro['details'] as $vo) {
    $cost = isset($vo['cost']) ? ($vo['cost'] / 100) : '';
    $weight = isset($vo['weight']) ? $vo['weight'] : '';
    echo '{"weight":"' . $weight . '","cost":"' . $cost . '","price":"' . ($vo['price'] / 100) . '","original":"' . ($vo['original'] / 100) . '","stock":"' . $vo['stock'] . '","sku":"' . addslashes($vo['sku']) . '","bundle":"' . ($vo['bundle'] / 100) . '","option":escape("' . str_replace('"', '\"', $vo['option']) . '"),"status":"' . $vo['status'] . '"},';
}
?>
                    ]
                }
                if (productJson.variants.length) {
                    optionRow = 1;
                    optionCol = new Array();
                    $("#addvariants-btn").click();
                    for (var i = 0; i < productJson.variants.length - 1; i++) {
                        addVariant();
                    }
                    for (var j = 0; j < productJson.variants.length; j++) {
                        optionCol[j] = productJson.variants[j].value.split(",");
                        optionRow = optionRow * productJson.variants[j].value.split(",").length;
                        $('#pdo' + j).val(productJson.variants[j].option);
                        $('#pdv' + j).importTags(productJson.variants[j].value);
                        $('#pdom' + j).val(productJson.variants[j].option_map);
                        $('#pdvm' + j).importTags(productJson.variants[j].value_map);
                    }
                    onChangeTag();
                }
                var guojia = [];
                $('.select-all').closest('div').find('ins').click(function () {
                    var lang = $(this).closest('div').find('.select-all').data('lang');
                    if ($(this).closest('div').hasClass('checked')) {
                        $("input[name='lang-" + lang + "[]']").each(function () {
                            this.checked = true;
                            $(this).closest('div').addClass('checked');
                            guojia = remove(guojia, this.value);
                            guojia.push(this.value);
                        });
                    } else {
                        $("input[name='lang-" + lang + "[]']").each(function () {
                            this.checked = false;
                    ...
                    guojia = remove(guojia, 'on');
                    window.frames["ifm"].document.getElementById("country").value = guojia.join(',');
                    window.frames["ifm"].document.getElementById("country1").value = guojia.join(',');
                });
                $('.dg-country-choose .icheckbox_flat-blue').find('input').on('ifChanged', function (event) {
                    if (this.checked) {
                        guojia = remove(guojia, this.value);
                        guojia.push(this.value);
                    } else {
            ...
            $("#dg-type").typeahead({source: [<?php foreach ($type as $vo) {
    echo '"' . $vo['title'] . '",';
} ?>]});
            ...
            var states = [
                "Animals & Pet Supplies"
                        ...
                        , "Arts & Entertainment / Party & Celebration / Gift Giving / Corsage & Boutonni脙篓re Pins"
                        , "Arts & Entertainment / Party & Celebration / Gift Giving / Corsages & Boutonni脙篓res"
                        ...
                        , "Arts & Entertainment / Party & Celebration / Party Supplies / Pi脙卤atas"
                        ...
                        , "Food, Beverages & Tobacco / Food Items / Fruits & Vegetables / Fresh & Frozen Fruits / Madro脙卤o"
                        ...
                        , "Food, Beverages & Tobacco / Food Items / Prepared Foods / Prepared Meals & Entr脙漏es"
                        ...
                        , "Health & Beauty / Health Care / Fitness & Nutrition / Nutritional Food Pur脙漏es"
                        ...
                        , "Home & Garden / Kitchen & Dining / Cookware & Bakeware / Cookware / Cr脙陋pe & Blini Pans"
                        ...
                        , "Home & Garden / Kitchen & Dining / Cookware & Bakeware / Cookware / Saut脙漏 Pans"
                        ...
                        , "Sporting Goods / Athletics / Fencing / Fencing Protective Gear / Fencing Jackets & Lam脙漏s"
            ...
            $("#erp_sku").typeahead({source: states, items: 100});
        </script>
    </body>
</html>