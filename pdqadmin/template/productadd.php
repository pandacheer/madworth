	...
	<body data-color="grey" class="flat">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-6 col-lg-6">
							<div class="text-right">
								<button type="submit" id="save" class="btn btn-default btn-bgcolor-white">Save</button>
							</div>	
						</div>	
				  </div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-8 col-lg-8">
						<div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
							<div class="form-group">
								...
								<input name="title" type="producttitle" class="form-control" id="producttitle">
							</div>
                                                        <div class="form-group">
								...
								<label for="topreview">topReview</label>
                                                                <textarea name="topreview" class="summernote"></textarea>
							</div>
						</div>	
						...
						<div class="widget-box widget-box-hledit widget-box-hledit-productadd-left widget-box-hledit-productadd-left-Pricingbox">
							...
							<div class="widget-content nopadding">
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
							      <div class="form-group col-sm-6">
									...
									<input name="cost" type="text" class="form-control" id="CostPrice" placeholder="￥">
								  </div>
								  <div class="form-group col-sm-6">
									<label for="GrossMargin">Gross Margin</label>
									<div class="input-group nopadding">
								      <input name="gross" type="text" class="form-control" id="GrossMargin" value="40">
							...
							<div class="widget-content nopadding">
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
								  <div class="form-group col-sm-6">
									<input type="checkbox" id="freebies" name="freebies" /><span style="vertical-align: super;">This is a freebies product</span>
								  </div>
								</div>  
								<div class="clearfix"></div>	
							</div>
							...
							<div class="widget-content nopadding">
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
								  <div class="form-group col-sm-6">
									...
									<input name="sold[init]" type="text" class="form-control" id="InitialSold" value="0">
								  </div>
								  <div class="form-group col-sm-6">
							    ...
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
								  ...
								  <div class="form-group col-sm-6">
									...
									<select name="track" class="selectbox">
									  <option value="1">Don't track inventory</option>
									  <option value="2">Use ERP data</option>
									</select>
								  </div>
								</div>  
								<div class="clearfix"></div>	
							...
							<div class="widget-content nopadding">
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
								  <div class="form-group col-sm-6">
									...
									<h5>
										<input name="weight" type="text" class="group-radius-left"> g
									</h5>
								  </div>
								</div>  
								<div class="clearfix"></div>	
							...
							<div class="widget-content nopadding" id="addvariants-hidebox">
							    <div class="col-xs-12 widget-box-hledit-productadd-left-Pricingbox-form">
									<div class="addvariants-hidebox-title">
										<span class="col-sm-6">Option Name</span>
										<span class="col-sm-6">Option Values</span>
										<div class="clearfix"></div>
									</div>
									<div class="addvariants-hidebox-inputbox-all">
										<div class="addvariants-hidebox-inputbox">  
											<div class="col-sm-4"><input type="text" name="variants[0][option]"></div>
											<div class="col-sm-6"><input type="text" class="tags" name="variants[0][value]"></div>
											<div class="col-sm-2"> 
												<button type="button" class="btn btn-default btn-bgcolor-write addvariants-delete">
										...
										<table class="table table-striped" id="addvariants-hidebox-inputbox-table">
											<thead>
												<tr>
													...
													<th class="addvariants-inputbox-one">Variant</th>
													<th class="addvariants-inputbox-two">Cost Price</th>
                                                                                                        <th class="addvariants-inputbox-two">Weight</th>
													<th class="addvariants-inputbox-three">Stock</th>
													<th class="addvariants-inputbox-stree">SKU</th>
												</tr>
											</thead>
											<tbody>
											</tbody>
                        ...
                        <div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
							...
							<div class="clearfix"></div>
							<div class="widget-content nopadding" >
								<input class="typeahead form-control" name="shopping_feed" type="text" id="erp_sku" placeholder="Google Shopping Category">
							</div>
						</div>
						...
						<div class="widget-box widget-box-hledit widget-box-hledit-productadd-left">
							...
							<div id="productadd-website-seo-hidebox">
								<div class="form-group col-sm-12">
									...
									<input name="seo[title]" type="text" class="form-control" id="page-title-seo" placeholder="SEO page title" />
								</div>
								<div class="form-group col-sm-12">
									<label for="Metadescription">Meta description</label>
									<textarea name="seo[description]" class="form-control" id="page-description" rows="3"></textarea>
								</div>
								<div class="form-group col-sm-12">
									<label for="URLandhandle">URL andhandle</label>
									<div class="input-group nopadding">
										<div class="input-group-addon">http://www.drgrab.com/</div>
										<input name="seo_url" type="text" class="form-control" id="page-url-seo" placeholder="AboutFreeShipping">
									</div>
								</div>
								<div class="clearfix"></div>
							</div>
							...
							<div class="widget-content nopadding">
								<div class="productcontent-right-onlinestorebox pull-left">
									<div class="productcontent-right-onlinestorebox-left">
										<input name="thumb" type="file" class="form-control" accept="image/jpeg">
									</div>
								</div>
							</div>
							<div class="clearfix"></div>
						...
						<div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
							...
							<div class="widget-content nopadding">
								  <div class="form-group">
									...
									<input name="type" type="text" class="form-control" id="dg-type" autocomplete="off">
								  </div>
								  <div class="form-group">
									<label for="exampleInputPassword1">Creator</label>
									<input name="creator" type="text" class="form-control" id="dg-creator" value="<?php echo $user ?>" readOnly>
								  </div>
								  <div class="form-group">
									...
									<input name="collection" type="hidden" id="hiddenselectval">
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
									...
									<input name="tag[Tag1]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer">
								  </div>
								  <div class="form-group">
									<label for="exampleInputPassword1">Tags2</label>
									<input name="tag[Tag2]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer">
								  </div>
								  <div class="form-group">
									<label for="exampleInputPassword1">Tags3</label>
									<input name="tag[Tag3]" type="text" class="form-control tags-rightinput" placeholder="Vintage, cotton, summer">
								  </div>
								  <div class="form-group">
									<label for="exampleInputPassword1">Keyword</label>
									<textarea name="seo[keyword]" class="form-control" placeholder="HTML,CSS,XML,JavaScript"></textarea>
								  </div>
							</div>
						</div>
                                            <div class="widget-box widget-box-hledit widget-box-hledit-productcontent-right">
							...
							<div class="widget-content nopadding">
                                <div class="form-group">
                                    <label><input name="GF_enable" type="checkbox" class="form-control" id="dg-GF_enable" value="1">
								...
								<div id="google" style="display: none">
									<div class="form-group">
										<label for="exampleInputEmail1">Color</label>
	                                        <input name="GF_color" type="text" placeholder="White,Black,Red" class="form-control tags-rightinput" id="dg-GF_color" autocomplete="off">
	                                </div>
	                                <div class="form-group">
										<label for="exampleInputEmail1">Size</label>
										<input name="GF_size" type="text" class="form-control tags-rightinput" placeholder="S,M,L,XL" id="dg-GF_size" autocomplete="off">
	                                </div>
									<div class="form-group">
					...
					<div class="produccontent-buttomsave-box">
						<div class="pull-right">
							<button type="submit" id="save1" class="btn btn-default btn-bgcolor-white">save</button>
						</div>
						<div class="clearfix"></div>
				    </div> 
				</div>
        ...
        $(function() {
          ...
          //seo content
        	$("#producttitle").bind('keyup',function(){
				...
				$("#page-url-seo").val($val.replace(/\s+/g,'-').replace(/\'/g,"").substr(0,60));
			});
			...
			$("#page-url-seo").on('change',function(){
				$changval = $(this).val().replace(/\s+/g,'-').replace(/\'/g,"").substr(0,60);
				$(this).val($changval);
			});
        });
        ...
        function onChangeTag(){
        	...
        	$(".addvariants-hidebox-inputbox").each(function(i){
        	   var gettags = $(this).find(".tag span").text();
        	   strs=gettags.split(" "); 
        	   strs.splice(length-1,1);
        	   tag_array[i] = strs;
        	})
        	var r = combin(tag_array);
        	var SKUinput = $("#SKUinput").val() ? $.trim($("#SKUinput").val())+"/" : '';
            //var productPrice = $('#Priceinput').val()
            //var BundlePrice = $('#bundlePrice').val()
            var CostPrice = $('#CostPrice').val()
        	for(i in r){
        		$("#addvariants-hidebox-inputbox-table tbody").append("<tr><td class=\"select\"><input type=\"checkbox\" id=\"title-checkbox\" name=\"title-checkbox\" /></td><td class=\"addvariants-inputbox-one\">"+r[i].join('/')+"</td><td class=\"addvariants-inputbox-two\"><input type=\"text\" name=\"details["+ i +"][price]\"></td><td class=\"addvariants-inputbox-two\"><input type=\"text\" name=\"details["+ i +"][weight]\"></td><td class=\"addvariants-inputbox-three\"><button type=\"button\" class=\"btn btn-default btn-sm btn-bgcolor-white\"><i class=\"fa fa-pencil\"></i></button><input type=\"hidden\" name=\"details["+ i +"][stock]\" value=\"0\"></td><td class=\"addvariants-inputbox-stree\"><input type=\"text\" value=\""+ SKUinput+r[i].join('/') +"\" name=\"details["+ i +"][sku]\"><input type=\"hidden\" name=\"details["+ i +"][status]\" value=\"1\"></td></tr>");
                if($("#addvariants-hidebox-inputbox-table").find("[name='details["+ i +"][price]']").val()===""){
                    $("#addvariants-hidebox-inputbox-table").find("[name='details["+ i +"][price]']").val(CostPrice);
                }
        	}
        	$('.addvariants-inputbox-three button').on('click',function(){
        		$(this).fadeOut(1).siblings('input').attr('type','text');
        	});
        }
        var vi=1;
        $("#Addoptionbtn").on('click',function(){
        	$(".addvariants-hidebox-inputbox-all").append("<div class=\"addvariants-hidebox-inputbox\"><div class=\"col-sm-4\"><input type=\"text\" name=\"variants["+ vi +"][option]\"></div><div class=\"col-sm-6\"><input type=\"text\" class=\"tags\" name=\"variants["+ vi +"][value]\"></div><div class=\"col-sm-2\"><button type=\"button\" class=\"btn btn-default btn-bgcolor-write addvariants-delete\"><i class=\"fa fa-trash-o fa-lg\"></i></button></div><div class=\"clearfix\"></div></div>");
        	vi++;
        ...
        $(document).on('click', '.addvariants-delete', function(event){ 
        	$(this).parent().parent(".addvariants-hidebox-inputbox").remove();
        	onChangeTag();
        });
        </script>
        <script>
